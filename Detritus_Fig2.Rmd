...
treatments[,"C_labs"] = c(rep(NA, times=4), contrast_groups(contrast_matrix_C)$group_labels)
...
pL = ggplot(data=treatments, aes(x=Food, y=Length, shape=Infected, fill=Infected)) + 
  ...
  geom_point(position = position_dodge(width=0.3)) + geom_text(aes(label=L_labs), position = position_dodge(width=1.1)) +
...
pE = ggplot(data=treatments, aes(x=Food, y=Eggs, shape=Infected, fill=Infected)) + 
  ...
  geom_point(position = position_dodge(width=0.3)) + geom_text(aes(label=E_labs), position = position_dodge(width=0.8)) +

...
pEI = ggplot(data=inf.only, aes(x=Food, y=Eggs)) + 
  ...
  geom_point() + geom_text(aes(label=E_labs, hjust=0), nudge_x = 0.2, nudge_y = 0) + ylim(c(0,50))
...
Fig1 = plot_grid(spacer, spacer,
  ...
  # x-axis tick labels
  draw_label("LF", x=0.17, y=0.05, size=8)+
  draw_label("DW", x=0.24, y=0.05, size=8)+
  draw_label("WF", x=0.31, y=0.05, size=8)+
  draw_label("WH", x=0.37, y=0.05, size=8)+
  draw_label("WL", x=0.44, y=0.05, size=8)+
  
  draw_label("LF", x=0.17+0.5, y=0.05+0.24, size=8)+
  draw_label("DW", x=0.24+0.5, y=0.05+0.24, size=8)+
  draw_label("WF", x=0.31+0.5, y=0.05+0.24, size=8)+
  draw_label("WH", x=0.37+0.5, y=0.05+0.24, size=8)+
  draw_label("WL", x=0.44+0.5, y=0.05+0.24, size=8)+
...
save_plot("C:/RData/Fig1_Detritus.png", Fig1, ncol=2, nrow=4, base_height=2, base_asp = 1.1, dpi=600, units="in")
